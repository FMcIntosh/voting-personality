...
export const Header = withTheme(({ theme, children, light }) => {
  const style = {
    color: light ? "white" : theme.palette.text.primary,
    fontSize: "40px",
    lineHeight: "48px",
...
export const Paragraph = withTheme(({ theme, children, light }) => {
  const style = {
  ...
  return (
    <Typography type="body1" align="center" gutterBottom style={style} >{children}</Typography>
  )
})
